...
<div class="row mt-4">
    <div class="col-md-5">
        <div class="row">
            ...
            <div class="col-md-3 ">
                <a href="{{route('addCommiissionSteupForm')}}"><i class="fa-duotone fa-solid fa-user-plus fa-sm bg-success rounded p-3" style="--fa-primary-color: #ffffff; --fa-secondary-color: #ffffff; --fa-secondary-opacity: 1;"></i></a>
            </div>
        </div>
    </div>
    <div class="col-md-6">
